...
3. The [GitHub project](https://github.com/andrew-worsfold/tailor-advanced)
4. The [Community Forum](https://support.gettailor.com/hc/en-us/community/topics)

If you like the plugin, you can help by [rating it](https://wordpress.org/support/view/plugin-reviews/tailor-advanced?rate=5#postform).
...
= 1.0.2 =
* Fixed - Stretched section backgrounds not working correctly on frontend.
