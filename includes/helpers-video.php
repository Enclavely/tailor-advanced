...
if ( ! function_exists( 'tailor_add_section_background_video_controls' ) ) {
	...
	/**
	 * Adds background video and parallax functionality to Section elements.
	 *
	 * @since 1.0.0
	 *
	 * @param Tailor_Section_Element $section_element
	 */
	function tailor_add_section_background_video_controls( $section_element ) {
		...
		// Update parallax control dependencies
	...
	add_action( 'tailor_element_register_controls_tailor_section', 'tailor_add_section_background_video_controls' );
}
